...
function Services() {
  return (
    ...
    "
        ...
        <div className=" mt-12 py-5  px-5 backgroundGrident ">
          <div className="flex pr-3  ">
            <div class="text-xl font-bold flex items-center gap-2 md:text-2xl md:w-[40%]">
              <p class="text-blue-500">01</p>
              <p className="text-white">Branding Design</p>
            </div>

            <div class="ml-auto  text-2xl origin-center md:order-last text-white rotate-45 transition duration-700  hover:rotate-[-45deg]">
              <i class="fa-solid fa-arrow-right"></i>
            </div>
          </div>
          <div class="md:max-lg:max-w-[600px] lg:max-w-[800px]  xl:w-[700px] px-9">
            <p
