      ...
      <div className="grid grid-cols-1 md:grid-cols-2 py-10 p-5 gap-10">
        ...
        <div className="border border-solid border-gray-700 p-3 grid gap-5   ">
          <div className=" flex justify-center items-center gap-3 p-3 ">
            <div class="text-3xl text-[#03e9f4]  md:text-4xl lg:text-5xl">
              <i class="fa-solid fa-medal"></i>
            </div>
            <div >
              <h2 class="text-white text-3xl font-bold md:text-3xl lg:text-4xl xl:text-5xl ">
                Experience
              </h2>
            </div>
          </div>
          <div className=" rounded-3xl  bg-black backgroundGrident  p-5 ">
            {/* <!-- card 1 --> */}
            <p class=" text- font-bold pb-3 text-blue-400">2022-Present</p>
            <p class="text-xl font-bold uppercase text-white lg:2xl xl:text-3xl">
              {" "}
              Lead Developer{" "}
            </p>
          ...
          <div className=" rounded-3xl  bg-black backgroundGrident  p-5">
            {/* <!-- card 2 --> */}
            <p class=" text- font-bold pb-3 text-blue-400"> 2021-2022</p>
            <p class="text-xl font-bold uppercase text-white lg:2xl xl:text-3xl">
              {" "}
          ...
          <div className=" rounded-3xl bg-black backgroundGrident  p-5">
            {/* <!-- card 3 --> */}
            <p class=" text- font-bold pb-3 text-blue-400">2022-2023</p>
            <p class="text-xl font-bold uppercase text-white lg:2xl xl:text-3xl">
              {" "}
              UI/UX designer{" "}
            </p>
          ...
          <div className=" rounded-3xl  bg-black backgroundGrident  p-5">
            {/* <!-- card 4 --> */}
            <p class=" text- font-bold pb-3 text-blue-400">2024-Present</p>
            <p class="text-xl font-bold uppercase text-white lg:2xl xl:text-3xl">
              {" "}
        ...
        <div className="border border-solid border-gray-700 p-3 grid gap-5 ">
          <div className=" flex justify-center items-center gap-3 p-3">
            <div class="text-3xl text-[#03e9f4] md:text-3xl lg:text-4xl xl:text-5xl">
          ...
          <div className=" rounded-3xl  bg-black backgroundGrident  p-5">
            {/* <!-- card 3 --> */}
            <p class=" text- font-bold pb-3 text-blue-400"> 2017-2020</p>
            <p class="text-xl font-bold uppercase text-white lg:2xl xl:text-3xl">
              {" "}
          ...
          <div className=" rounded-3xl  bg-black backgroundGrident  p-5">
            {/* <!-- card 4 --> */}
            <p class=" text- font-bold pb-3 text-blue-400"> 2014-2016</p>
            <p class="text-xl font-bold uppercase text-white lg:2xl xl:text-3xl">
              {" "}
              Basic Academic{" "}
            </p>
