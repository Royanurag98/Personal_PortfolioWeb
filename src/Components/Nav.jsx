      ...
      <div className="container mx-auto flex justify-between items-center  z-20 ">
        ...
        <nav className=" sidebar hidden md:flex space-x-8 xl:space-x-6  
         ...
         xl:font-medium  lg:max-xl:font-medium  md:max-lg:font-medium
          ...
          <a href="#resumeSection" className=" hover:text-[#0bc7e0]">Resume</a>
        ...
        <button class=" btn2 md:block shadow-md shadow-slate-500 cursor-pointer rounded-md p-2 ">
                  <span class="z-10 px-5 py-2 text-[15px] font-sans font-bold ">Hire Me!</span>
                </button>
